...
public class Persistencia {
    ...
    private static void inicializarVehiculos(){
       /* Sucursal s1 = sucursales.get(0);
        ...
        VehiculoElectrico v1 = new VehiculoElectrico("AE123FG", new Marca("Renaul","Francia") , "Kangoo E-Tech", 2020, 1000, s1, 16);
